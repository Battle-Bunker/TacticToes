...
echo ""
echo "IMPORTANT - Organization Policy Note:"
echo "  If this project is under a GCP Organization with Domain Restricted Sharing"
echo "  (iam.allowedPolicyMemberDomains), you must first allow public access:"
echo ""
...
echo ""
echo "  To find your org ID: gcloud organizations list"
echo ""
...
echo "=========================================="
echo ""
echo "Firebase callable functions require 'allUsers' to have the invoker role."
echo "This is because:"
echo "  - GCP IAM and Firebase Auth are separate systems"
echo "  - The browser needs to reach the function endpoint (GCP IAM layer)"
echo "  - Firebase Auth tokens are validated inside the function code"
echo ""
echo "If this fails with 'User allUsers is not in permitted organization', you need"
echo "to remove the organization-level Domain Restricted Sharing policy first:"
echo "  gcloud org-policies delete iam.allowedPolicyMemberDomains --organization=YOUR_ORG_ID"
echo ""
