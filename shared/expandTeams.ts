import { GamePlayer, Team, UnitCounts, UnitType } from "./types/Game"
...
/**
 * Expands the lobby's teams into the units that play the game. The single
 * implementation: functions/ and frontend/ both re-export this file, so the
 * lobby preview and the units the server generates cannot disagree.
 *
